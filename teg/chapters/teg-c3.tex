...
\begin{center}
    \textit{[Placeholder: Fragmento del archivo docker-compose.yml o captura de consola demostrando la orquestación y el estado de los contenedores]}
\end{center}
...
\begin{center}
    \textit{[Placeholder: Captura del listado de alertas priorizadas en el Frontend]}
\end{center}
\begin{center}
    \textit{[Placeholder: Captura del Chat con el asistente de IA en la vista de Alertas]}
\end{center}
