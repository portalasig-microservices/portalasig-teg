...
independientes ---UAA (gesti\'{o}n de identidad), Site (sitios acad\'{e}micos) y Notify
(notificaciones)--- cada uno con su propia base de datos, su esquema de
versionado y su ciclo de despliegue aut\'{o}nomo. Sobre esta arquitectura se
implementaron t\'{e}cnicas sistem\'{a}ticas de mantenimiento de software que abarcan
todo el ciclo de vida del c\'{o}digo: integraci\'{o}n continua con validaci\'{o}n
...
Intelligent MAPE-K Agent), que ejecuta un ciclo de autogesti\'{o}n del mantenimiento
