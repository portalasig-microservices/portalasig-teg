...
\begin{description}
    ...
    \item[Faker] Biblioteca que genera datos sintéticos aleatorios (nombres, direcciones, identificadores) para poblar pruebas sin utilizar información real.
    ...
    \item[IT] Information Technology (del inglés): conjunto de herramientas, sistemas y prácticas para el procesamiento, almacenamiento y transmisión de datos en organizaciones.
    ...
    \item[Scraping] Mecanismo de recolección de datos mediante extracción periódica (\textit{scraping}) desde endpoints expuestos por los servicios monitoreados, como el modelo utilizado por Prometheus para obtener métricas.
\end{description}
